...
$securityGroupsSheet.Cells[1, 2].Value = "Group Description"
$securityGroupsSheet.Cells[1, 3].Value = "Group Member"
...
foreach ($group in $securityGroupsWithMembers) {
    ...
    $securityGroupsSheet.Cells[$row, 2].Value = $group.GroupDescription
    $securityGroupsSheet.Cells[$row, 3].Value = $group.GroupMember
    $row++
}
